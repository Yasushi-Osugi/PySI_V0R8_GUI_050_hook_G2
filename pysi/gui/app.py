...
class PSIPlannerApp:
    ...
    def setup_ui(self):
        ...
        view_menu.add_command(label="World Map (global)", command=self._show_worldmap_global)
        view_menu.add_command(label="World Map (fit to data)", command=self._show_worldmap_fit)
