...
class PSIPlannerApp:
    ...
    def setup_ui(self):
        ...
        self.gmp_label = ttk.Label(self.frame, text="Market Potential:")
        self.gmp_label.pack()
        self.gmp_entry = tk.Entry(self.frame, width=10)
        self.gmp_entry.pack()

        self.ts_label = ttk.Label(self.frame, text="TargetShare(%)")
        self.ts_label.pack()
        self.ts_entry = tk.Entry(self.frame, width=5)
        self.ts_entry.pack()
        self.ts_entry.insert(0, self.config.DEFAULT_TARGET_SHARE * 100)

        self.tsp_label = ttk.Label(self.frame, text="Total Supply:")
        self.tsp_label.pack()
        self.tsp_entry = tk.Entry(self.frame, width=10)
        self.tsp_entry.pack()
