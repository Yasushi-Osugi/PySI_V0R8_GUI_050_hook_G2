...
# pysi/core/node_base.py (V0R7マージ版)
#import pandas as pd
#from .operations import shiftS2P_LV  # core/内
...
class Node:
    ...
    #@251025 ADD for V0R8
    # ... (V0R7のクラス定義そのまま)
    def get_nodes(self):  # 互換用
        return [self] + [c for child in self.children for c in child.get_nodes()]
