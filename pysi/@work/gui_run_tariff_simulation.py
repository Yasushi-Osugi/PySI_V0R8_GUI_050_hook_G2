gui_run_tariff_simulation.py

# 呼び出し方法
#from evaluate_cost_models import gui_run_tariff_simulation
#
## ボタン設定（例）
#tariff_btn = tk.Button(root, text="Run Tariff Simulation", command=lambda: gui_run_tariff_simulation(product_tree_dict))
#tariff_btn.pack()
